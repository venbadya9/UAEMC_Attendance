...
@IBDesignable class CustomTabBar: UITabBar {
    ...
    @IBInspectable public var barBackColor = UIColor.theme
    ...
    @IBInspectable public var circleBackColor = UIColor.theme
    ...
    private func positionItem(barRect: CGRect, totalCount: Int, index: Int, item: UITabBarItem, view: UIView) {
        ...
        if self.selectedItem == item {
            yPosition = barRect.origin.y - (self.circleRadius / 2) + 1.0
        }
